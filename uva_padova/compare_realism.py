...
|---|---|---|
| Mean normalised error | {v['level_norm_err']['T1DMSIM']:.2f} | {v['level_norm_err']['UVA/Padova']:.2f} |
...
| Summary | T1DMSIM | UVA/Padova |
|---|---|---|
| Mean normalised error | {v['dyn_norm_err']['T1DMSIM']:.2f} | {v['dyn_norm_err']['UVA/Padova']:.2f} |
