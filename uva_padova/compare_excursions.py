...
|---|---|---|
| Peak rise (mg/dL) | {o['peak_diff_ours_minus_uva']['median']:+.0f} | {o['peak_diff_ours_minus_uva']['iqr_lo']:+.0f}–{o['peak_diff_ours_minus_uva']['iqr_hi']:+.0f} |
| Time-to-peak (min) | {o['tpeak_diff_ours_minus_uva']['median']:+.0f} | {o['tpeak_diff_ours_minus_uva']['iqr_lo']:+.0f}–{o['tpeak_diff_ours_minus_uva']['iqr_hi']:+.0f} |
