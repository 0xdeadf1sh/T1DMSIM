...
`bg_z = (bg - 161.3) / 61.5`. For robust scaling
that is resistant to extreme-hyper outliers: `bg_robust = (bg - 154.5) / 85.2`
(median / IQR).

| Stat (mg/dL) | Ohio | Shanghai | AZT1D | **Sim** |
|---|---:|---:|---:|---:|
| mean    | 162.1  | 164.7  | 146.4  | **161.3**  |
| median  | 155.0  | 156.6  | 138.0  | **154.5**  |
| std     | 60.9   | 72.3   | 47.6   | **61.5**   |
| IQR     | 87.0   | 106.2   | 57.0   | **85.2**   |
| p1      | 57.0    | 41.3    | 65.0    | **56.9**    |
| p99     | 326.0   | 349.2   | 293.0   | **331.9**   |
...
| TBR1 | 54-70   |  2.51 |  4.72 |  1.21 | **3.45** |
| TIR  | 70-180  |  60.7  |  54.7  |  77.8  | **60.9**  |
| TAR1 | 180-250 |  27.3 |  25.1 |  16.9 | **26.4** |
| TAR2 | >250    |   8.8 |  12.6 |   3.8 | **8.7** |
...
|---|---:|---:|---:|---:|
| Hypo (<70) episodes        | 252   | 169   | 570   | **20,455** |
| Severe-hypo (<54) episodes | 58    | 78    | 117    | **5,665** |
| Hyper (>180) episodes      | 847  | 305  | 2,752  | **55,389** |
| Severe-hyper (>250) episodes | 340  | 192  | 626  | **24,156** |
...
|---|---:|---:|---:|
| **Sim vs Ohio**     | 0.014 | 1.4 | 0.002 |
| **Sim vs Shanghai** | 0.070 | 10.0 | 0.016 |
| **Sim vs AZT1D**    | 0.153 | 17.8 | 0.025 |
...
Wasserstein-1 distances are 1.4 (min) / 9.7 (mean) mg/dL,
...
Note the smallest gap is Sim-vs-Ohio (1.4 mg/dL), which falls *below* the 10.1 mg/dL real-vs-real floor — the simulator is tuned against OhioT1DM specifically, so a sub-floor distance reflects that tuning, not general realism beyond that cohort.
...
| **mean** | 162.1 | 164.7 | 146.4 | 161.3 | -0.8 | -3.5 | +14.9 |
| **median** | 155.0 | 156.6 | 138.0 | 154.5 | -0.5 | -2.1 | +16.5 |
| std | 60.9 | 72.3 | 47.6 | 61.5 | +0.6 | -10.8 | +13.9 |
| IQR | 87.0 | 106.2 | 57.0 | 85.2 | -1.8 | -21.0 | +28.2 |
| CV (%) | 37.6 | 43.9 | 32.5 | 38.1 | +0.6 pp | -5.8 pp | +5.6 pp |
| skewness | 0.58 | 0.51 | 1.03 | 0.63 | +0.05 | +0.12 | -0.40 |
| excess kurtosis | 0.15 | -0.14 | 1.56 | 0.25 | +0.10 | +0.39 | -1.31 |
| min | 40.0 | 39.6 | 40.0 | 40.0 | — | — | — |
| max | 400.0 | 475.2 | 400.0 | 400.0 | — | — | — |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| p1 | 57.0 | 41.3 | 65.0 | 56.9 | -0.1 | +15.6 | -8.1 |
| p5 | 76.0 | 61.2 | 84.0 | 73.4 | -2.6 | +12.2 | -10.6 |
| p10 | 88.0 | 75.6 | 95.0 | 86.7 | -1.3 | +11.1 | -8.3 |
| p25 | 115.0 | 108.0 | 114.0 | 114.8 | -0.2 | +6.8 | +0.8 |
| p50 | 155.0 | 156.6 | 138.0 | 154.5 | -0.5 | -2.1 | +16.5 |
| p75 | 202.0 | 214.2 | 171.0 | 200.0 | -2.0 | -14.2 | +29.0 |
| p90 | 245.0 | 264.6 | 210.0 | 244.0 | -1.0 | -20.6 | +34.0 |
| p95 | 271.0 | 291.6 | 238.0 | 272.8 | +1.8 | -18.8 | +34.8 |
| p99 | 326.0 | 349.2 | 293.0 | 331.9 | +5.9 | -17.3 | +38.9 |
...
| Sim vs Ohio | 0.014 | 3.5 × 10⁻¹⁴ | 1.4 | 0.002 |
| Sim vs Shanghai | 0.070 | 1.7 × 10⁻⁶⁶ | 10.0 | 0.016 |
| Sim vs AZT1D | 0.153 | < 10⁻³⁰⁰ | 17.8 | 0.025 |
...
|---|---|---|---|---|
| GMI / eA1c proxy | 7.19 ± 0.39 | 7.22 ± 0.74 | 6.83 ± 0.38 | 7.17 ± 0.39 |
| **LBGI** (low-BG risk) | 0.86 ± 0.49 | 1.82 ± 1.76 | 0.50 ± 0.39 | **0.89 ± 0.66** |
| **HBGI** (high-BG risk) | 7.60 ± 2.53 | 8.58 ± 4.28 | 4.65 ± 2.36 | **7.47 ± 2.32** |
| J-index | 49.2 ± 9.2 | 52.6 ± 17.1 | 37.1 ± 9.7 | 48.9 ± 9.4 |
| M-value (ref 120) | 11.1 ± 3.8 | 15.8 ± 6.2 | 5.8 ± 3.4 | 11.0 ± 3.6 |

Pooled (not per-record) risk indices, for reference:

| | Ohio | Shanghai | AZT1D | Sim |
|---|---:|---:|---:|---:|
| LBGI (pooled) | 0.86 | 1.87 | 0.51 | 0.89 |
| HBGI (pooled) | 7.54 | 8.87 | 4.56 | 7.47 |
| J-index (pooled) | 49.7 | 56.2 | 37.6 | 49.6 |
| M-value (pooled) | 11.0 | 16.5 | 5.7 | 11.0 |
...
| TBR1 (54–70)      | 2.51 ± 1.57 | 4.72 ± 3.97 | 1.21 ± 1.26 | 3.45 ± 2.97 |
| **TIR (70–180)**  | **60.7 ± 10.2** | **54.7 ± 14.5** | **77.8 ± 10.7** | **60.9 ± 8.2** |
| TAR1 (180–250)    | 27.3 ± 6.1 | 25.1 ± 11.7 | 16.9 ± 7.4 | 26.4 ± 5.9 |
| TAR2 (>250)       | 8.83 ± 6.09 | 12.64 ± 8.91 | 3.77 ± 4.32 | 8.70 ± 4.87 |
...
| MAGE (mg/dL)        | 102.6 ± 14.9     | 123.4 ± 30.0¹     | 78.2 ± 16.1     | 98.3 ± 15.0     |
| CONGA-1h (mg/dL)    | 39.5 ± 5.6 | 34.2 ± 7.2 | 37.5 ± 5.5 | 38.3 ± 6.2 |
| CONGA-4h (mg/dL)    | 76.2 ± 11.5 | 75.1 ± 17.7 | 62.5 ± 12.9 | 75.0 ± 10.1 |
...
| 30 min  | 0.909 | 0.946  | 0.846 | 0.928 |
| 1 h     | 0.764 | 0.840  | 0.617 | 0.785 |
| 2 h     | 0.483 | 0.606  | 0.248 | 0.491 |
| 4 h     | 0.137 | 0.254  | -0.015 | 0.185 |
| **8 h**     | **-0.004** | **-0.028** | **-0.021** | **0.034** |
| **12 h**    | **-0.010** | **-0.050** | **-0.020** | **-0.016** |
| 24 h    | 0.116 | 0.378  | 0.203 | **0.101** |
...
AZT1D 6.02 mg/dL · Sim 5.44 mg/dL.
...
| Sim | 146 | 148 | 149 | 152 | 159 | 168 | 178 | 185 | 188 | 186 | 181 | 175 | 169 | 165 | 161 | 158 | 155 | 154 | 152 | 150 | 149 | 148 | 147 | 146 |
...
| Sim | 138 | 140 | 141 | 144 | 152 | 161 | 173 | 181 | 183 | 182 | 177 | 172 | 165 | 159 | 156 | 152 | 149 | 147 | 143 | 141 | 142 | 141 | 140 | 138 |
...
|---|---|---|---|---|
| Hypo (<70) episodes / day      | 0.86 ± 0.43 | 1.02 ± 0.74 | 0.53 ± 0.45 | **0.97 ± 0.74** |
| Severe-hypo (<54) eps / day   | 0.20 ± 0.21 | 0.51 ± 0.47 | 0.11 ± 0.12 | 0.27 ± 0.35 |
| Hyper (>180) episodes / day   | 2.86 ± 0.27 | 1.87 ± 0.71 | 2.65 ± 0.89 | 2.64 ± 0.44 |
| Severe-hyper (>250) eps / day | 1.17 ± 0.43 | 1.12 ± 0.68 | 0.62 ± 0.59 | 1.15 ± 0.49 |
| Hypo median duration (min)    | 34.6 | 69.4 | 26.6 | 50.0 |
| Hypo p90 duration (min)       | 89.6 | 179.2 | 49.3 | **84.7** |
| Hyper median duration (min)   | 127.9 | 213.3 | 75.5 | 128.8 |
| Hyper p90 duration (min)      | 421.8 | 622.6 | 226.9 | **429.2** |
...
|---|---:|---:|---:|
| Excursions detected | 2266 | 8770 | 145606 |
| &nbsp;&nbsp;rises unexplained (%) | 60.7 | 79.2 | 77.4 |
| &nbsp;&nbsp;falls unexplained (%) | 35.4 | 28.0 | 72.9 |
| &nbsp;&nbsp;all unexplained (%) | 48.9 | 54.4 | 75.2 |
| Explained load (mg/dL/day) | 393 | 364 | 190 |
...
| Δ-BG SD, full trace (mg/dL) | 5.89 | 6.02 | 5.44 |
| Δ-BG SD, unexplained censored (mg/dL) | 5.85 | 5.64 | 5.36 |
...
simulator's unexplained load (558 mg/dL/day) sits near the
...
|---|---:|---:|---:|
| Mean basal rate (U/hr)            | 0.92 | 1.50 | +0.58 |
| Median basal rate (U/hr)          | 0.67 | 1.18 | +0.51 |
| Basal P10–P90 spread (U/hr)       | 0.20 – 2.03 | 0.30 – 3.16 | — |
| Carbs / day (g, per-subject mean) | 121.8 | 210.8 | +89.0 |
| Total insulin / day (U)           | 51.9 | 56.2 | +4.3 |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Pooled mean BG (mg/dL) | 161.3 | 162.1 | 164.7 | 146.4 | -0.8 | -3.5 | +14.9 |
| Pooled median BG (mg/dL) | 154.5 | 155.0 | 156.6 | 138.0 | -0.5 | -2.1 | +16.5 |
| Pooled std (mg/dL) | 61.5 | 60.9 | 72.3 | 47.6 | +0.6 | -10.8 | +13.9 |
| Pooled CV (%) | 38.1 | 37.6 | 43.9 | 32.5 | +0.6 | -5.8 | +5.6 |
| Pooled skewness | 0.63 | 0.58 | 0.51 | 1.03 | +0.05 | +0.12 | -0.40 |
| Pooled excess kurtosis | 0.25 | 0.15 | -0.14 | 1.56 | +0.10 | +0.39 | -1.31 |
| Pooled p99 (mg/dL) | 331.9 | 326.0 | 349.2 | 293.0 | +5.9 | -17.3 | +38.9 |
| GMI (per-record mean) | 7.17 | 7.19 | 7.22 | 6.83 | -0.02 | -0.06 | +0.34 |
| LBGI (per-record mean) | 0.89 | 0.86 | 1.82 | 0.50 | +0.03 | -0.93 | +0.39 |
| HBGI (per-record mean) | 7.47 | 7.60 | 8.58 | 4.65 | -0.13 | -1.11 | +2.82 |
| TIR % (per-record mean) | 60.9 | 60.7 | 54.7 | 77.8 | +0.3 | +6.2 | -16.9 |
| TBR1 % (per-record mean) | 3.45 | 2.51 | 4.72 | 1.21 | +0.94 | -1.27 | +2.24 |
| TBR2 % (per-record mean) | 0.53 | 0.72 | 2.79 | 0.26 | -0.19 | -2.26 | +0.27 |
| TAR1 % (per-record mean) | 26.4 | 27.3 | 25.1 | 16.9 | -0.9 | +1.3 | +9.5 |
| TAR2 % (per-record mean) | 8.7 | 8.8 | 12.6 | 3.8 | -0.1 | -3.9 | +4.9 |
| MAGE (mg/dL) | 98.3 | 102.6 | 123.4 | 78.2 | -4.3 | -25.1 | +20.0 |
| CONGA-1h (mg/dL) | 38.3 | 39.5 | 34.2 | 37.5 | -1.2 | +4.2 | +0.9 |
| CONGA-4h (mg/dL) | 75.0 | 76.2 | 75.1 | 62.5 | -1.2 | -0.1 | +12.5 |
| MODD (mg/dL) | 62.4 | 61.1 | 53.3 | 42.1 | +1.3 | +9.1 | +20.3 |
| Hypo episodes / day | 0.97 | 0.86 | 1.02 | 0.53 | +0.11 | -0.05 | +0.44 |
| Severe-hypo eps / day | 0.27 | 0.20 | 0.51 | 0.11 | +0.07 | -0.24 | +0.16 |
| Hyper episodes / day | 2.64 | 2.86 | 1.87 | 2.65 | -0.22 | +0.77 | -0.01 |
| Severe-hyper eps / day | 1.15 | 1.17 | 1.12 | 0.62 | -0.02 | +0.03 | +0.53 |
| Hypo p90 duration (min) | 84.7 | 89.6 | 179.2 | 49.3 | -4.9 | -94.5 | +35.4 |
| Hyper p90 duration (min) | 429.2 | 421.8 | 622.6 | 226.9 | +7.4 | -193.4 | +202.3 |
...
|---|---:|---:|---:|---:|---:|---:|
| Wasserstein-1 (mg/dL) | 1.4 | 10.0 | 17.8 | 10.1 | 18.1 | 26.9 |
| KS statistic | 0.014 | 0.070 | 0.153 | 0.064 | 0.157 | 0.190 |
...
| ACF @ 30 min | 0.909 | 0.946 | 0.846 | **0.928** |
| ACF @ 60 min | 0.764 | 0.840 | 0.617 | **0.785** |
| ACF @ 120 min | 0.483 | 0.606 | 0.248 | **0.491** |
| Hypo eps / day | 0.96 | 1.02 | 0.64 | **1.01** |
...
|---|---:|---:|---:|---:|---:|---:|
| Energy distance | 0.128 | 0.917 | 1.890 | 0.910 | 1.971 | 2.594 |
| Cramér–von Mises | 1.7 | 13.0 | 65.8 | 11.6 | 75.9 | 107.7 |
| Anderson–Darling | 10.8 | 131.5 | 471.2 | 133.3 | 525.0 | 875.1 |
| Total variation | 0.032 | 0.124 | 0.190 | 0.127 | 0.191 | 0.279 |
| Hellinger | 0.044 | 0.135 | 0.161 | 0.140 | 0.160 | 0.251 |
| Histogram overlap | 0.968 | 0.876 | 0.810 | 0.873 | 0.809 | 0.721 |
...
| Poincaré SD2 (mg/dL) | 82.2 | 87.7 | 61.5 | **82.7** |
| Poincaré SD1/SD2 | 0.126 | 0.088 | 0.169 | **0.107** |
| Spectral entropy (0–1) | 0.530 | 0.496 | 0.622 | **0.559** |
| Spectral centroid (cyc/h) | 0.110 | 0.085 | 0.150 | **0.100** |
| DFA α (Hurst) | 1.432 | 1.537 | 1.325 | **1.467** |
...
Transition-matrix distance from Sim: Ohio 0.492 · Shanghai 0.754 ·
AZT1D 0.491 (Frobenius; lower = more similar dynamics).
...
|---|---|---|---|---|
| Pooled mean (mg/dL) | 162.1 [151.0, 177.6] | 164.7 [149.7, 180.8] | 146.4 [140.1, 153.3] | **161.3 [159.5, 163.0]** |
| Pooled std (mg/dL) | 60.9 [52.9, 66.0] | 72.3 [66.0, 77.2] | 47.6 [43.3, 52.1] | **61.5 [60.6, 62.4]** |
| TIR % (70–180) | 60.9 [51.1, 68.3] | 53.6 [46.0, 60.8] | 78.2 [73.6, 82.2] | **60.9 [60.0, 61.8]** |
| LBGI | 0.86 [0.49, 1.29] | 1.87 [0.98, 2.74] | 0.51 [0.37, 0.67] | **0.89 [0.82, 0.97]** |
...
|---|---:|---:|---:|---:|---:|:--:|
| cf_hypo_per_day | 1.01 | 0.96 | 1.02 | 0.64 | +0.63 | yes |
| TBR2% | 0.53 | 0.71 | 2.83 | 0.27 | -0.54 | yes |
| sd_ratio | 0.11 | 0.13 | 0.09 | 0.17 | -0.50 | yes |
| cf_conga_1h | 38.34 | 39.55 | 34.17 | 37.45 | +0.47 | yes |
| mean | 161.30 | 162.07 | 164.75 | 146.42 | +0.36 | yes |
| cf_hyper_per_day | 2.65 | 2.81 | 1.87 | 2.74 | +0.34 | yes |
| dfa_alpha | 1.47 | 1.43 | 1.54 | 1.33 | +0.34 | yes |
| TBR1% | 3.45 | 2.49 | 4.82 | 1.25 | +0.33 | yes |
| excess_kurt | 0.25 | 0.15 | -0.14 | 1.56 | -0.30 | yes |
| cf_delta_std | 12.53 | 14.55 | 10.65 | 14.26 | -0.29 | yes |
| acf_efold_min | 168.27 | 159.98 | 201.21 | 100.47 | +0.28 | yes |
| skew | 0.63 | 0.58 | 0.51 | 1.03 | -0.28 | yes |
| LBGI | 0.89 | 0.86 | 1.87 | 0.51 | -0.27 | yes |
| TIR% | 60.94 | 60.93 | 53.62 | 78.25 | -0.26 | yes |
| HBGI | 7.47 | 7.54 | 8.87 | 4.56 | +0.22 | yes |
| spectral_entropy | 0.56 | 0.53 | 0.50 | 0.62 | +0.15 | yes |
| std | 61.49 | 60.86 | 72.31 | 47.60 | +0.10 | yes |
| cf_mage | 108.29 | 109.49 | 123.38 | 87.27 | +0.09 | yes |
| cv_pct | 38.12 | 37.55 | 43.89 | 32.51 | +0.02 | yes |
| TAR2% | 8.70 | 8.63 | 13.48 | 3.65 | +0.02 | yes |
